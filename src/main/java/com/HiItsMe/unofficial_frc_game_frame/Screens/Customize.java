...
public class Customize extends FRCScreen {
    ...
    public void init() {
        ...
        buttons[0] = new SaveButton((7*(1256/8))-(253/2), (4*(570/7))-(99/2));
        buttons[1] = new CancelButton((7*(1256/8))-(253/2), (4*(570/5))-(99/2));
        upgs[0] = new UpgradeSelector(5, (1*(1256/8))-(20/2), (6*(570/16))-(20/2), 0);
        upgs[1] = new UpgradeSelector(2, (1*(1256/8))-(20/2), (7*(570/16))-(20/2), 0);
        upgs[2] = new UpgradeSelector(3, (1*(1256/8))-(20/2), (8*(570/16))-(20/2), 1);
        upgs[3] = new UpgradeSelector(1, (1*(1256/8))-(20/2), (9*(570/16))-(20/2), 0);
        //Initialize images
        for(int i = 1; i < 4; i++) {
            try {
    ...
    public void draw() {
        ...
        FrameMain.gui.g2d.drawString("Customize Robot", 1256 / 8, 72);
        FrameMain.gui.g2d.setFont(lineMarkerFont);
        FrameMain.gui.g2d.drawString("SPEED", 1256 / 32, (6 * (570 / 16)) + 6);
        FrameMain.gui.g2d.drawString("SHOOTER", 1256 / 32, (7 * (570 / 16)) + 6);
        FrameMain.gui.g2d.drawString("DRIVETRAIN", 1256 / 32, (8 * (570 / 16)) + 6);
        FrameMain.gui.g2d.drawString("AUTONOMOUS", 1256 / 32, (9 * (570 / 16)) + 6);
        FrameMain.gui.g2d.setFont(detailFont);
        FrameMain.gui.g2d.drawString("TANK", (1256/8)-8, (8 * (570 / 16))+15);
        FrameMain.gui.g2d.drawString("ARCADE", (1256/8)-12+(25), (8 * (570 / 16))+15);
        FrameMain.gui.g2d.drawString("SWERVE", (1256/8)-12+(25*2), (8 * (570 / 16))+15);
        FrameMain.gui.g2d.setFont(assetsFont);
        FrameMain.gui.g2d.drawString("Assets: " + (maxAssets - assets) + "/" + maxAssets, 2 * (1256 / 3), 72);
        try {
            //Draw robot
